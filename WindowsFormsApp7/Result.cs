...
namespace WindowsFormsApp7
{
    public partial class Result : Form
    {
        ...
        private void btnPdf_Click(object sender, EventArgs e)
        {
            ...
            reader.Close();
                //int ab = -1;
                //SqlCommand q=new SqlCommand("Select MAX(MeasurementLevel) From RubricLevel Where RubricId='"+ Convert.ToInt32(rb_Id) + "'",connection);
            ...
            for(int i=0; i<5; i++)
            {
                ...
                float obtain = (Convert.ToInt32(MeasurementLevel) / 25) * Total;
            ...
            document.Add(table);
            document.Close();
            MessageBox.Show("Check pdf inj directory");
                connection.Close();
